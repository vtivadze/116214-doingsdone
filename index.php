...
if ($con && isset($_POST['add']) && $_POST['add'] == 'Добавить') {
...
if ($con && isset($_POST['add_project']) && $_POST['add_project'] == 'Добавить') {
...
if ($con && isset($_POST['search_task']) && $_POST['search_task'] == 'Искать') {
